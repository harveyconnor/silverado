            ...
            <div class="content-main">
                ...
                <div class="card">
                    <div class="card-content">
                        ...
                        <form action="cart.php" method="POST" id="ticket-form" onkeyup="printSubtotal()" onsubmit="return formCheck()">
                            ...
                            <div class="form-group" id="subtotalLoc">
                                ...
                                <button class="button button-primary button-large button-block" id="booking-button">Make booking!</button>
                            </div>
                        </form>
                    </div>
                </div>
